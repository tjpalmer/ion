...
const TypeInfo *typeinfo_table[178] = {
    ...
    [167] = NULL, // Func
    [168] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(12, TYPE_LLONG, llong)},
    [169] = NULL, // Func
    [170] = NULL, // No associated type
    [171] = NULL, // No associated type
    [172] = NULL, // Func
    [173] = &(TypeInfo){TYPE_CONST, .size = sizeof(llong const ), .align = alignof(llong const ), .base = TYPEID(12, TYPE_LLONG, llong)},
    [174] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(173, TYPE_CONST, llong const )},
    [175] = NULL, // Func
    [176] = NULL, // Func
    [177] = NULL, // Func
};
